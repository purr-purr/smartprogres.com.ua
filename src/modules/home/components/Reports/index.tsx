...
import {archiveInfo, infoOwnershipStructure, news,} from '@modules/home/components/Reports/data';
    ...
    return (
        <SplitBlocks title="Інформація" titleType="heading" anchor="reports">
            ...
            <Accordion title="Відповідальність страхового посередника">
                <p>
                    Інформація про наявність договору страхування відповідальності під час здійснення посередницької
                    діяльності у сфері страхування (перестрахування): Річний ліміт покриття професійної
                    відповідальності,
                    наданий АТ «СК ГАРДІАН» для ТОВ &quot;СТРАХОВИЙ БРОКЕР &quot;СМАРТПРОГРЕС&quot; та становить: 1 469
                    990,00
                    гривень.
                </p>
            </Accordion>
